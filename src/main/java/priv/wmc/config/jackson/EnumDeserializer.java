...
import priv.wmc.common.utils.RegexUtils;
...
@Slf4j
@JsonComponent
public class EnumDeserializer <T extends Enum<? extends EnumDefine> & EnumDefine> extends JsonDeserializer<T> {
    ...
    public T deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (!RegexUtils.isInteger(valueString)) {
            ...
            return (T)enumConstants[0].getDefault();
        }
