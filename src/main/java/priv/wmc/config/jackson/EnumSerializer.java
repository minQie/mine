...
public class EnumSerializer extends JsonSerializer<EnumDefine> {
    ...
    public void serialize(EnumDefine enumDefine, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        gen.writeNumberField(StaticConfig.ENUM_SERIALIZE_KEY_NAME, enumDefine.getValue());
        gen.writeStringField(StaticConfig.ENUM_SERIALIZE_VALUE_NAME, enumDefine.getDescription());
        gen.writeEndObject();
