    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        try {
            ...
            if (request.getMethod().equals(HttpMethod.POST.name())) {
                ...
                log.debug("IP:{}, Method:{}, URI:{} Body:{}", request.getRemoteAddr(), request.getMethod(), request.getRequestURI() + query, ((MultiReadHttpServletRequest) request).getRequestBody().replaceAll("\n", ""));
            } else {
                log.debug("IP:{}, Method:{}, URI:{}", request.getRemoteAddr(), request.getMethod(), request.getRequestURI() + query);
            }
